...
describe("modifyUrls", () => {
    it("should modify TikTok URLs", () => {
        arrayOfTestUrls.forEach((url) => {
            console.log((0, modifyUrls_1.modifyUrls)(url));
            expect((0, modifyUrls_1.modifyUrls)(url)).toMatch(/tnktok\.com/);
        });
    });
    it("should modify Instagram URLs", () => {
        arrayOfInstagramUrls.forEach((url) => {
            console.log((0, modifyUrls_1.modifyUrls)(url));
            expect((0, modifyUrls_1.modifyUrls)(url)).toMatch(/ddinstagram\.com/);
        });
    });
});
//# sourceMappingURL=modifyUrls.spec.js.map